package td.issuing.demo.repository;

import td.issuing.demo.JhipsterSampleApplicationApp;
import td.issuing.demo.config.Constants;
import td.issuing.demo.config.audit.AuditEventConverter;
import td.issuing.demo.domain.PersistentAuditEvent;
...
import static td.issuing.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
